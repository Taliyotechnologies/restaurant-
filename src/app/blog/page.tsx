        ...
        <div className="relative container-max mx-auto px-6 md:px-8 py-12 md:py-16">
          ...
          <div className="mt-8 flex items-center justify-center gap-3">
            <div className="relative w-full max-w-[560px]">
              <div className="relative flex items-center gap-3 border border-black bg-transparent px-3 py-2 shadow-[0_2px_0_#000]">
                <input
                  type="email"
                  placeholder="What is your email address? *"
                  className="flex-1 h-10 md:h-12 rounded-sm border border-black bg-[#fbf3dd] px-4 text-sm md:text-base text-neutral-900 placeholder:text-neutral-600 focus:outline-none focus:ring-2 focus:ring-black/40"
                />
                <button
                  type="button"
                  className="px-5 md:px-6 h-10 md:h-12 bg-[#ef2d2d] text-black border-2 border-black rounded-sm font-semibold text-sm md:text-base shadow-[0_2px_0_#000]"
                >
                  I subscribe
                </button>
              </div>
            </div>
            <Image src={hand} alt="" width={460} height={170} className="h-16 md:h-20 w-auto select-none pointer-events-none" />
          </div>

          <div className="mt-10">
            <div className="h-[2px] bg-black/60" />
            <div className="mt-6 flex items-center justify-between gap-2 flex-nowrap">
              ...
              <form className="flex items-center gap-2">
                <input
                  type="text"
                  placeholder="search"
                  className="w-[140px] md:w-[220px] h-9 md:h-10 rounded-sm border border-black bg-[#fbf3dd] px-3 text-xs md:text-sm text-neutral-900 placeholder:text-neutral-600 focus:outline-none focus:ring-2 focus:ring-black/40"
                />
                <button type="submit" className="px-3 md:px-4 h-9 md:h-10 bg-[#ef2d2d] text-black border-2 border-black rounded-sm font-semibold text-xs md:text-sm shadow-[0_2px_0_#000]">Search</button>
              </form>
            </div>
          </div>
